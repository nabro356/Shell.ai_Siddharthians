...
DISEASE_CODES = {
    ...
    "gastroenteritis": {
        ...
        "codes": ["25374005"],
        "keywords": ["loose stool", "diarrhoea", "blood in stool", "vomit", "nausea", "dysentery", "loose motion", "gastro"],
        "category": "waterborne",
        "alert_rules": [
            {
                "level": "P2",
    ...
    "typhoid": {
        "name": "Typhoid Fever",
        "codes": ["4834000"],  # Generic SNOMED code; user can add specific dataset codes
        ...
        "alert_rules": [
            {
                "level": "P2",
                "name": "Cluster",
                "description": "≥5 cases of typhoid in a mandal in 1 week",
                "type": "threshold_mandal",
                "min_cases": 5,
                "window_weeks": 1,
            },
            {
                "level": "P3",
                "name": "Surge",
                "description": "Weekly cases double the 4-week baseline average",
                "type": "surge",
                "multiplier": 2.0,
                "baseline_weeks": 4,
            }
    ...
    "febrile_illness": {
        ...
        "codes": ["386661006"],
        "keywords": ["fever", "febrile", "pyrexia", "high temperature", "afi"],
        "category": "syndromic",
        "alert_rules": [
            {
                "level": "P2",
                "name": "Syndromic Cluster",
                "description": "≥50 fever cases in a mandal in 1 week",
                "type": "threshold_mandal",
                "min_cases": 50,
                "window_weeks": 1,
            },
            {
                "level": "P3",
                "name": "Surge",
                "description": "Fever cases double the 4-week baseline average",
                "type": "surge",
                "multiplier": 2.0,
                "baseline_weeks": 4,
            }
